...
### 1. Lock down `staging.camsprep.com`
...
### 2. Course-bundle pages have zero commerce schema
...
### 3. Orphaned/conflicting duplicate schema on blog posts
...
### 4. `/cams-mock-tests/` — fix the page-type mismatch
...
### 5. Consolidate the "what is CAMS certification" 4-way collision
...
### 6. Consolidate the CAMS exam cost/ROI 3-way collision
...
### 7. Fix the bundle-page purchase flow (performance + mobile CTA)
...
### 8. Fix the sitewide tablet header
...
### 10. Reconcile the pass-rate self-contradiction
...
### 12. Enrich the author Person schema
...
### 13. Fix faceted-URL canonicalization in the sitemap
...
### 15. Fix the LCP lazy-load/fetchpriority conflict
...
### 16. Compress and modernize bundle/blog images
...
### 17. Add 9 Google Fonts requests → 1 on bundle pages
...
### 18. Fix mobile chat-widget overlaps
...
### 19. Target "CAMS certification cost" as a head term
...
### 20. Build a real bundle-comparison matrix
...
### 21. Clean up remaining sitemap thin content
