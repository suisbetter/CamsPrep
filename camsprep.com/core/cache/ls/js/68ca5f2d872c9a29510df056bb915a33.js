(() => {
    var t = {
                                ...
                                s.oninput = t => {
                                    ...
                                    if (0 == m(l)) {
                                        ...
                                        a.querySelectorAll(".tutor-form-select-option").forEach(t => {
                                            if (t.classList.contains("noItem") == !0) {
                                                n = !0
                                            }
                                        });
                                        if (!1 == n) {
                ...
                t(document).on("click", '.tutor-single-course-lesson-comments button[type="submit"]', function(e) {
                    ...
                    t.ajax({
                        ...
                        beforeSend: function t() {
                            r.addClass("is-loading").prop("disabled", !0)
                        },
                        complete: function t() {
                        ...
                        success: function e(e) {
                            ...
                            t(".tutor-comment-line").css("height", "calc(100% - 308px)");
                            t("textarea").val("")
                        },
                        error: function t(t) {
                            r.removeClass("is-loading").prop("disabled", !1)
                        }
                    })
                })
            })
        ...
        37691: function() {
            window.jQuery(document).ready(t => {
                ...
                var e = t("#tutor-quiz-time-update");
                if (e.length) {
                    var r = JSON.parse(e.attr("data-attempt-settings"));
                    var o = JSON.parse(e.attr("data-attempt-meta"));
                                ...
                                if (_tutorobject.quiz_options.quiz_when_time_expires === "auto_submit") {
                                    ...
                                    t.ajax({
                                        ...
                                        success: function r(r) {
                                            ...
                                            t(n).addClass("tutor-alert-show");
                                            if (a > 0) {
                                                t("".concat(n, " .tutor-quiz-alert-text")).html(__("Your time limit for this quiz has expired, please reattempt the quiz. Attempts remaining:", "tutor") + " " + a + "/" + o)
                                            } else {
                                                ...
                                                t("".concat(n, " .tutor-quiz-alert-text")).html("".concat(__("Unfortunately, you are out of time and quiz attempts. ", "tutor")));
        ...
        9008: function() {
            window.jQuery(document).ready(t => {
                    ...
                    if (i()) {
                        ...
                        n.each(function() {
                            ...
                            if (i === "radio" || i === "checkbox") {
                                var s = o.indexOf(n.val()) > -1;
                                var c = n.is(":checked");
                                if (s) {
                                    n.closest(".tutor-quiz-answer-single").addClass("tutor-quiz-answer-single-correct").append(u(__("Correct Answer", "tutor"))).find(".tutor-quiz-answer-single-info:eq(1)").remove()
                                } else {
                                    if (n.prop("checked")) {
                ...
                t(".tutor-quiz-next-btn-all").prop("disabled", !1);
                t(".quiz-attempt-single-question input").filter('[type="radio"], [type="checkbox"]').change(function() {
                ...
                t(document).on("click", ".tutor-quiz-answer-next-btn, .tutor-quiz-answer-previous-btn", function(r) {
                    ...
                    var a = parseInt(t(this).closest("[data-question_index]").data("question_index"));
                ...
                t("body").on("submit", "form#tutor-start-quiz", function() {
                    t(this).find("button").prop("disabled", !0)
                })
            })
        },
        39061: function() {
        ...
        43963: function(t, e, r) {
            var {
                get_response_message: o
            } = r(12235);
            window.jQuery(document).ready(t => {
                var {
                    __
            ...
            window.jQuery(document).ready(t => {
                ...
                var e = function e(e) {
                    ...
                    this.accept_upload_image = function(e, r) {
                        ...
                        e.update_preview(r.currentTarget.name, o);
                        n(o, {
                            width: 1200
                        }, t => {
                ...
                r.length > 0 ? new e(r).initialize() : 0;
                t(".tutor-profile-settings-save").click(function(e) {
                    ...
                    if (window.tinyMCE !== undefined) {
                        ...
                        n.tutor_profile_bio = s.getContent({
                            format: "html"
                        })
                    }
        ...
        2935: function() {
            document.addEventListener("DOMContentLoaded", () => {
                ...
                t('.tutor-dashboard-setting-withdraw input[name="tutor_selected_withdraw_method"]').on("change", function(e) {
                    ...
                    o.find(".withdraw-method-form").hide().filter('[data-withdraw-form="' + r.val() + '"]').show()
                })
            })
        },
        69951: function() {
            window.jQuery(document).ready(t => {
                ...
                t(".tutor-course-retake-button").prop("disabled", !1).click(function(e) {
                    e.preventDefault();
                            ...
                            reset: {
                                ...
                                callback: function e(e) {
                                    t.ajax({
                                        ...
                                        beforeSend: () => {
                                            e.prop("disabled", !0).addClass("is-loading")
                                        },
                                        success: function t(t) {
                                            if (t.success) {
                                        ...
                                        complete: function t() {
                                            e.prop("disabled", !1).removeClass("is-loading")
                                        }
                                    })
                                }
                            },
            ...
            jQuery(document).ready(function(t) {
                ...
                t("[tutor-instructors]").each(function() {
                    ...
                    function s(o, a, n) {
                        ...
                        o ? r[o] = a : r = {};
                        r.attributes = u;
                        r.action = "load_filtered_instructor";
                        i.html('<div class="tutor-spinner-wrap"><span class="tutor-spinner" aria-hidden="true"></span></div>');
                        t.ajax({
                            url: window._tutorobject.ajaxurl,
                            data: r,
                            type: "POST",
                    ...
                    e.on("change", '[tutor-instructors-filter-category] [type="checkbox"]', function() {
                        var e = {};
                        t(this).closest("[tutor-instructors-filter-category]").find("input:checked").each(function() {
                        ...
                        var r = document.querySelectorAll("[tutor-instructors-filter-rating]");
                        for (var o of r) {
        ...
        12235: function(t, e, r) {
            ...
            var o = (t, e) => {
                ...
                var {
                    message: o = e || __("Something Went Wrong!", "tutor")
                } = r;
                return o
            }
        }
    ...
    (() => {
        ...
        function e(e) {
            for (var r = 1; r < arguments.length; r++) {
                ...
                if (typeof Object.getOwnPropertySymbols === "function") {
                    a = a.concat(Object.getOwnPropertySymbols(o).filter(function(t) {
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            v === null || v === void 0 ? void 0 : v.addEventListener("change", t => {
            ...
            if (h) {
                h.onsubmit = t => a(function*() {
                    ...
                    try {
                        ...
                        var i = yield fetch(window._tutorobject.ajaxurl, {
                            method: "POST",
                            body: e
                        });
                        ...
                        if (i.ok) {
                            ...
                            if (s.success || 200 === (s === null || s === void 0 ? void 0 : s.status_code)) {
                                ...
                                var {
                                    message: u = __("Something went wrong, please try again ", "tutor")
                                } = s.data || {};
                    ...
                    if (a.ok) {
                        ...
                        if (s) {
                            if (typeof s === "object" && s.success) {
                                ...
                                location.reload(!0)
                            } else if (typeof s === "object" && s.success === !1) {
        ...
        const d = l;
        var v = ["keyword", "course_order", "tutor-course-filter-type", "tutor-course-filter-level", "tutor-course-filter-tag", "tutor-course-filter-category", "tutor-course-filter-price", "course_filter", "supported_filters", "current_page", "action"];
        var f = t => {
            var e = function(e) {
        ...
        var p = t => {
            ...
            var r = m();
            t.find('[type="checkbox"]').prop("checked", !1);
            t.find('[type="text"], select').val("");
            for (var o in r) e(o)
        };
        window.jQuery(document).ready(t => {
            var {
            ...
            var s = function() {
                ...
                r.html('<div class="tutor-spinner-wrap"><span class="tutor-spinner" aria-hidden="true"></span></div>');
            ...
            t("[tutor-toggle-course-filter]").on("click", function(e) {
                ...
                if (t(".tutor-course-filter-backdrop").length == 0) {
                    t("body").append(t('<div class="tutor-course-filter-backdrop" aria-hidden="true"></div>').hide().fadeIn(150))
                }
            });
            ...
            u.forEach(t => {
                t.onclick = t => a(function*() {
                    ...
                    var o = [{
                        ...
                        course_id: r.dataset.courseId
                    }];
                    if (r.dataset.subscriptionEnrollment) {
                        o.push({
                            tutor_subscription_enrollment: !0
                        })
                    }
                    var a = d(o);
                    r.classList.add("is-loading");
        ...
        document.addEventListener("DOMContentLoaded", t => {
            ...
            m();
            window.addEventListener(_tutorobject.content_change_event, m);
            ...
            function z() {
                var t;
                var e = [...C.files].reduce((t, e) => t + e.size, 0);
            ...
            T.forEach(t => {
                t.onclick = t => a(function*() {
                    ...
                    a.set("file_name", r);
                    a.set(window.tutor_get_nonce_data(!0).key, window.tutor_get_nonce_data(!0).value);
        ...
        document.addEventListener("DOMContentLoaded", () => a(function*() {
            ...
            if (t) {
                ...
                t.addEventListener("change", t => {
                    ...
                    var n = document.querySelector("[name=billing_state]");
                    if (a && a.length > 0) {
                        n.innerHTML = "";
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            var t = __("Something went wrong, please try again", "tutor");
            document.addEventListener("click", e => a(function*() {
                var r = e.target.closest(".tutor-native-add-to-cart");
                if (r) {
                    var o = d([{
                        action: "tutor_add_course_to_cart",
                        course_id: r.dataset.courseId
                    }]);
                    ...
                    try {
                        ...
                        if (s === 201) {
                            tutor_toast(__("Success", "tutor"), c, "success");
                            var l;
                            var v = '<a data-cy="tutor-native-view-cart" href="'.concat((l = u === null || u === void 0 ? void 0 : u.cart_page_url) !== null && l !== void 0 ? l : "#", '" class="tutor-btn tutor-btn-outline-primary ').concat(a ? "tutor-btn-lg tutor-btn-block" : "tutor-btn-md", " ").concat(!(u === null || u === void 0 ? void 0 : u.cart_page_url) ? "tutor-cart-page-not-configured" : "", '">').concat(__("View Cart", "tutor"), "</a>");
                            r.parentElement.innerHTML = v;
                            var f = new CustomEvent("tutorAddToCartEvent", {
                                detail: {
                                    cart_count: u === null || u === void 0 ? void 0 : u.cart_count
                                }
                            });
                    ...
                    if (r) {
                        ...
                        try {
                            ...
                            if (i === 200) {
                                ...
                                tutor_toast(__("Success", "tutor"), u, "success");
                                var c = new CustomEvent("tutorRemoveCartEvent", {
                                    detail: {
            ...
            if (e) {
                ...
                document.addEventListener("click", e => a(function*() {
                    if (e.target.closest(".tutor-checkout-payment-options")) {
                        ...
                        var i = a.querySelectorAll("label");
                    ...
                    if (e.target.closest("#tutor-apply-coupon-button")) {
                        ...
                        var k = new FormData;
                        k.set(window.tutor_get_nonce_data(!0).key, window.tutor_get_nonce_data(!0).value);
                ...
                d === null || d === void 0 ? void 0 : d.addEventListener("submit", function(t) {
                    t.preventDefault();
                    var e = u();
                ...
                function v(t) {
                    ...
                    return a(function*() {
                        ...
                        var u = new FormData;
                        u.set(window.tutor_get_nonce_data(!0).key, window.tutor_get_nonce_data(!0).value);
                ...
                function _(t) {
                    return a(function*() {
                        t.set(window.tutor_get_nonce_data(!0).key, window.tutor_get_nonce_data(!0).value);
                ...
                f === null || f === void 0 ? void 0 : f.addEventListener("change", t => a(function*() {
                ...
                m === null || m === void 0 ? void 0 : m.addEventListener("change", t => a(function*() {
                    var e = document.querySelector("[name=coupon_code]");
                    var r = f.value;
                    var o = t.target.value;
                ...
                function g() {
                    ...
                    if (i.length === 1) {
                        ...
                        i[0].querySelector("input[name=payment_method]").checked = !0;
        ...
        jQuery(document).ready(function(t) {
            ...
            var i = {
                ...
                track_player: function r() {
                    ...
                    if (typeof Plyr !== "undefined") {
                        ...
                        var n = new Plyr(this.player_DOM, {
                            keyboard: {
                                focused: r.isRequiredPercentage() ? false : !0,
                                global: !1
                            },
                            listeners: e({}, r.isRequiredPercentage() && {
                                seek(t) {
                                    var e = r.getTargetTime(n, t);
                                    var o = n.currentTime;
                                    var a = o > r.max_seek_time ? o : r.max_seek_time;
                                    if (e > a) {
                                        t.preventDefault();
                        ...
                        n.on("ready", function(e) {
                            ...
                            if (_tutorobject.tutor_pro_url && i > 0) {
                                ...
                                var c = setTimeout(function() {
                                    if (n.playing !== !0 && n.currentTime !== s) {
                            ...
                            if (t(r.player_DOM).closest(".tutor-course-topic-single-body .tutor-video-player-wrapper").length) {
                                var l = new CustomEvent("tutorLessonPlayerReady", {
                                    detail: {
                                        player: o
                                    }
                                });
                ...
                isRequiredPercentage: function t() {
                    ...
                    var {
                        strict_mode: e,
                        control_video_lesson_completion: r,
                        lesson_completed: o,
                        is_enrolled: a
                    } = t;
                ...
                disable_complete_lesson_btn: function e() {
                    ...
                    if (i < a) {
                        ...
                        s.after('<span class="tooltip-txt tooltip-bottom">'.concat(n(__("Watch at least %s%% to complete the lesson.", "tutor"), e.required_percentage), "</span>"))
                    }
                },
            ...
            if (jQuery.datepicker) {
                t(".tutor_report_datepicker").datepicker({
                    dateFormat: "yy-mm-dd"
                })
            }
            ...
            t("form").on("change", ".tutor-assignment-file-upload", function() {
                t(this).siblings("label").find("span").html(t(this).val().replace(/.*(\/|\\)/, ""))
            });
            ...
            t(document).on("click", function(e) {
                ...
                var o = r.find(".tutor-dropdown-content");
            ...
            if (d.length == 0) {
                ...
                t.fn.tutor_tooltip = function() {
                    this.on("mouseenter click", ".tooltip", function(e) {
                        e.stopPropagation();
